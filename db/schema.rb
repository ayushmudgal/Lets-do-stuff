...
ActiveRecord::Schema.define(version: 20151117033928) do
  ...
  add_index "user_rooms", ["category_id"], name: "index_user_rooms_on_category_id", using: :btree
  ...
  add_foreign_key "user_rooms", "categories"
end
